...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/cascade/2.2.04-cms3/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/charybdis/1.003-cms3/include
...
ALL_TOOLS      += cmsswdata
cmsswdata_EX_FLAGS_CMSSW_DATA_PACKAGE  := CalibCalorimetry/CaloMiscalibTools=V01-00-00 CalibTracker/SiPixelESProducers=V02-00-00 Calibration/Tools=V01-00-00 CondFormats/JetMETObjects=V01-00-01 Configuration/Generator=V01-00-00 DQM/PhysicsHWW=V01-00-00 DetectorDescription/Schema=V02-02-01 FastSimulation/MaterialEffects=V04-02-08 FastSimulation/PileUpProducer=V04-05-18 Fireworks/Geometry=V07-05-00 GeneratorInterface/EvtGenInterface=V01-00-00 GeneratorInterface/ReggeGribovPartonMCInterface=V00-00-02 L1Trigger/L1TCalorimeter=V01-00-02 L1Trigger/RPCTrigger=V00-15-00 MagneticField/Interpolation=V01-00-00 RecoBTag/SoftLepton=V01-00-01 RecoEgamma/ElectronIdentification=V01-00-01 RecoHI/HiJetAlgos=V01-00-01 RecoJets/JetProducers=V05-10-13 RecoLocalCalo/EcalDeadChannelRecoveryAlgos=V01-00-00 RecoMET/METPUSubtraction=V01-00-00 RecoMuon/MuonIdentification=V01-12-01 RecoParticleFlow/PFBlockProducer=V02-04-02 RecoParticleFlow/PFProducer=V15-00-00 RecoParticleFlow/PFTracking=V13-01-00 SimG4CMS/Calo=V03-00-00 SimG4CMS/Forward=V02-03-18 Validation/Geometry=V00-07-00

ALL_TOOLS      += coral
ALL_SCRAM_PROJECTS += coral
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/coral/CORAL_2_3_21-odfocd/include/LCG
coral_ORDER := 98000
...
ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/evtgen/1.3.0-cms7/include
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/hector/1_3_4-cms15/include
...
ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/herwig/6.521-cms3/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/herwigpp/2.7.1-cms6/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/jimmy/4.2-cms3/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/lhapdf/6.1.5-cms/include
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/mctester/1.25.0a-cms15/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/pythia8/205-cms/include
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/rivet/2.2.0-cms3/include
rivet_EX_LIB := Rivet

ALL_TOOLS      += roofitcore
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/roofit/5.34.22-cms3/include
...
ALL_TOOLS      += rootcint
rootcint_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/5.34.22-cms3/cint
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/5.34.22-cms3/include
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/sherpa/2.1.1-cms8/include/SHERPA-MC
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/tauolapp/1.1.5-cms3/include
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/thepeg/1.9.2p1-cms2/include
...
ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/yoda/1.3.0-cms3/include
yoda_EX_LIB := YODA
yoda_EX_USE := boost
